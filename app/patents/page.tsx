...
export default function PatentsPage() {
  ...
  return (
    ...
    >
      <h1 className="text-3xl lg:text-4xl font-light text-white mb-8 tracking-tight">
        Patents
      </h1>
          ...
          >
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-white/60 mb-4 italic text-sm">Inventors: {patent.inventors}</p>

                <div className="mb-4">
                  <h3 className="text-sm font-medium text-white mb-2">Abstract</h3>
                  <p className="text-white/80 leading-relaxed text-sm">{patent.abstract}</p>
                </div>

                <div className="mb-4">
                  <h3 className="text-sm font-medium text-white mb-2">Key Claims</h3>
                  <ul className="list-decimal pl-5 text-white/70 space-y-2 text-sm">
                ...
                <div>
                  <h3 className="text-sm font-medium text-white mb-2">Applications</h3>
